...
import Functionality.TlApprovalFunctionality;

@SuppressWarnings("rawtypes")
public class TlApprovalDesign {
	public static JFrame tlApprovalFrame;
	...
	public static JButton btnConfirmed;
	...
	public TlApprovalDesign(Map<String, Object> valueMap){
		try {
		...
		tlApprovalFrame = new JFrame("TL Apporval");
		pnlMain = new JPanel();
		...
		btnConfirmed = new JButton("Confirmed Leave");
		...
		TlApprovalFunctionality.loadTable((String) valueMap.get("tlFilterComboValue"));
	...
	public void heightWidth(){
		...
		tlApprovalFrame.setBounds(0, 0, 900, 700);
		...
		btnConfirmed.setBounds(240, 550, 135, 40);
		...
		pnlMain.add(btnConfirmed);
		pnlMain.add(btnRejectApproved);
		pnlMain.add(btnBack);

		tlApprovalFrame.add(pnlMain);

		tlApprovalFrame.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				...
				if (confirmed == JOptionPane.YES_OPTION) {
					tlApprovalFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				}else{
					tlApprovalFrame.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
				}
			}
		});
		
		tlApprovalFrame.setVisible(true);
		tlApprovalFrame.setResizable(false);
		tlApprovalFrame.setLocationRelativeTo(null);
